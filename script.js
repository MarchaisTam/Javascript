...
let operation = prompt("Choix entre addition – soustraction – multiplication – division");
...
let a = parseInt(prompt("Choisissez un premier chiffre"));
while(isNaN(a) && a !== " "){
    alert("Premier chiffre incorrect");
    a = prompt("Choisissez un premier chiffre");
}
console.log(a);



let b = parseInt(prompt("Choisissez un deuxième chiffre"));
while(isNaN(b) && b !== " "){
    alert("Deuxième chiffre incorrect");
    b = prompt("Choisissez un deuxième chiffre");
}
console.log(b);
...
function addition(a, b) {
    let res = a + b;
    console.log("L'addition de " + a + " + " + b + " est égale à " + res);
}

function soustraction(a, b) {
    let res = a - b;
    console.log("La soustraction de " + a + " + " + b + " est égale à " + res);
}

function multiplication(a, b) {
    let res = a * b;
    console.log("La multiplication de " + a + " + " + b + " est égale à " + res);
}

function division(a, b) {
    let res = a / b;
    console.log("La division de " + a + " + " + b + " est égale à " + res);
}
